    ...
    return (
        ...
        <div className=" w-full grid sm:grid-cols-2 md:grid-cols-4  gap-4" >
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className=" text-amber-300 dark:text-amber-400 text-xl font-semibold mb-3">Total number of students</h3>
                <p className=" text-5xl font-medium">{totalStudents}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3">Total number of faculties</h3>
                <p className=" text-5xl font-medium">{totalFaculty}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3" >Total number of Laboratories</h3>
                <p className=" text-5xl font-medium">{totalLabs}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3" >Number of students engaged in projects</h3>
                <p className=" text-5xl font-medium">{engagedStudents}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3" >Number of faculties engaged in projects</h3>
                <p className=" text-5xl font-medium">{engagedFaculty}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3" >Number of Ongoing projects</h3>
                <p className=" text-5xl font-medium">{ongoingProjects}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3" >Number of Planned projects</h3>
                <p className=" text-5xl font-medium">{plannedProjects}</p>
            </div>
            <div className=" flex flex-col justify-center p-5 rounded-lg text-center bg-teal-600 dark:bg-teal-500 text-white">
                <h3 className="  text-amber-300 dark:text-amber-400  text-xl font-semibold mb-3" >Number of Completed projects</h3>
